...
class ClienteNaturalSchema extends Schema {
  up () {
    this.create('cliente_naturals', (table) => {
      ...
      table.text('genero')
      table.text('profecion_oficio')
      table.text('condicion_vivienda')
      table.text('carga_familiar')
      table.text('estado_civil')
      table.text('direccion_domicilio')
      table.text('ciudad_domicilio')
      table.text('estado_domicilio')
      table.text('codigo_postal_domicilio')
      table.text('pais_domicilio')
